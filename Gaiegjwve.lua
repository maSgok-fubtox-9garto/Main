local Configs_HUB = {
    Cor_Hub = Color3.fromRGB(15, 15, 15),          -- أسود داكن جداً (شبه أسود)
    Cor_Options = Color3.fromRGB(30, 30, 30),      -- أسود فاتح قليلاً
    Cor_Stroke = Color3.fromRGB(230, 30, 30),       -- أحمر داكن أنيق
